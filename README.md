...
<body>
  ...
  <div class="main">
    ...
    <h1 class="support-card">❗이것부터 확인하세요</h1>
            <div>
                <ul>
     ...
     <div style="margin-bottom: 20px;">
        <h1 class="support-card">나의 경력에 맞는 지원 확인하기</h1>
            <ul>
...
대학발 창업 / 지역 일반 유형으로 구분</li>
    ...
    <div id="academy" class="section">
      ...
      <h1 class="support-card2">청년 창업 사관학교란❓</h1><br>
      ...
      <div>
        <h1 class="support-card2">💡지원대상</h1><br>
        <P>만 39세 이하 창업기업의 대표(창업 후 3년 이내 기업)</P>
        <p>고용 및 부가가치 창출이 높은 기술 집약 업종(혁신 제조 융·복합 업종)</p>
      </div><br>
      <div>
        <h1 class="support-card2">💡지원 내용</h1><br>
        <ul>
    ...
    <div id="helper" class="section">
      <h1>청년 창업 지원 도우미</h1>
      <p>창업을 준비하는 청년을 위한 맞춤형 지원 정보를 제공합니다.</p><br><hr>
      <div>
        <h1 class="support-card3">청년 창업 지원 도우미란❓</h1><br>
      ...
      <div>
        <h1 class="support-card3">💡주요 지원 내용</h1>
        <ul>
      ...
      <div>
        <h1 class="support-card3">💡지원 기관 및 사이트</h1>
      ...
      <div>
        <h1 class="support-card3">💡창업 지원금 종류</h1>
        <ul>
      ...
      <div>
        <h1 class="support-card3">💡지원 절차</h1><br>
        <ol>
      ...
      <div>
        <h1 class="support-card3">💡창업 지원 도우미 활용</h1><br>
        <ul>
